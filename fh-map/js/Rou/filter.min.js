...
//Remap if it is array
    r=this.getterFns[e](t),"Array"==c(r)&&(this.schema[e]="Array")}catch(t){console.log("Error while generating getter function for selector : "+e+" NOTE: Define manually")}}},u=function(t,e){for(var i,r=0,n=0,s=e.length-1,a=e.length-1;a>=0;a--)i=e.slice(0,a+1).join("."),"Array"==t[i]&&a<s&&(r=a,n+=1);return n>1?r+1:-1},f=function(t,e){for(var i,r,n,s="",a=t.split("."),h=u(this.schema,a),c=a.length-1;c>=0;c--)i=a.slice(0,c+1).join("."),r="['"+a[c]+"']",s="Array"==this.schema[i]?h==c?r+(s.length?".every(function(r"+c+"){  objs.push(r"+c+s+")})":""):r+(s.length?".map(function(r"+c+"){  return r"+c+s+"})":""):r+s;return n=h>-1?"var objs = []; obj"+s+";"+("Date"==this.schema.path?"return parseDate(objs)":"return objs;"):"return "+("Date"==this.schema.path?"parseDate(obj"+s+");":"obj"+s+";"),new Function("obj",n)};a.operators={eq:function(t,e){return t==e},ne:function(t,e){return t!=e},lt:function(t,e){return t<e},lte:function(t,e){return t<=e},gt:function(t,e){return t>e},gte:function(t,e){return t>=e},in:function(t,e){return e.indexOf(t)>-1},ni:function(t,e){return e.indexOf(t)==-1},li:function(t,e){return e.test(t)},bt:function(t,e){return t>=e[0]&&t<=e[1]}},a.addOperator=function(t,e){this.operators[t]=e};
// rVal = Record Value
// cVal = Condition Value
    var p=function(t,e,i){var r=0,n=t.length;for(r;r<n;r++)if(i(t[r],e))return!0};a.addCondition=function(t,e){this.operators[t]=e},a.getCriteria=function(t){var e=t.split(".$");return{field:e[0],operator:e[1]||"eq"}},a.setGetterFn=function(t,e){this.getterFns[t]=e},a.addRecords=function(t){return!(!t||!t.length)&&("Array"==c(t)?this.records=this.records.concat(t):this.records.push(t),this.schema||h(this,t[0]),!0)},a._findAll=function(t,e,i,n){var s,a,h,c=[],o=this.getterFns[e];return"li"==n&&"string"==typeof i&&(i=new RegExp(i)),s=this.operators[n],"Array"==this.schema[e]&&(h=s,s=p),r(t,function(t){a=o(t),s(a,i,h)&&c.push(t)}),c},a.find=function(t,e){var i,r;return e||(e=t,t=this.id),r=this.getterFns[t],n(this.records,function(t){if(r(t)==e)return i=t,!1}),i},r(["where","or","groupBy","select","pluck","limit","offset","order","uniq","near"],function(t){a[t]=function(e){var i=new y(this,this.records);return i[t].apply(i,arguments),i}}),r(["update_all","destroy_all"],function(t){a[t]=function(e){var i=new y(this,this.records);return i[t].apply(i,arguments)}}),r(["count","first","last","all"],function(t){Object.defineProperty(a,t,{get:function(){return new y(this,this.records)[t]}})});var g=function(t,e,i){for(var r=0,n=i.length;r<n;r++)if(this.getterFns[i[r]](t)!==this.getterFns[i[r]](e))return!1;return!0},d=function(t,e){var i,r,n;for(i in t)r=this.jQ.getCriteria(i),n=this.jQ._findAll(n||e,r.field,t[i],r.operator);return n},v=function(t,e){var i,n=this.jQ.getterFns[t],s={};e.length;return r(e,function(t){i=n(t),(s[i]||(s[i]=[])).push(t)}),s},m=function(t,e){for(var i,r,n=e.slice(0),s=0,a=t.length;s<a;s++)i=this.jQ.getterFns[t[s].field],r="asc"==t[s].direction?1:-1,n.sort(function(t,e){var n=i(t),s=i(e);return(n<s?-1:n>s?1:0)*r});return n},_=function(t,e){var i,n=this,s=[];return r(t,function(t){i=n.jQ.getterFns[t],r(e,function(e,r){(s[r]||(s[r]={}))[t]=i(e)})}),s},P=function(t,e){var i=this.jQ.getterFns[t],n=[];return r(e,function(t){n.push(i(t))}),n},b=function(t,e){var i=[],n=this;return"Object"!=c(e[0])?(r(e,function(t){i.indexOf(t)==-1&&i.push(t)}),i):(i.push(e[0]),r(e,function(e){for(var r=!1,s=0,a=i.length;s<a;s++)g.call(n.jQ,i[s],e,t)&&(r=!0);r||i.push(e)}),i)},y=function(t,e){return this.jQ=t,this.records=e,this.criteria={},this},j=y.prototype;j.each=function(t,e){r(this.exec()||[],t,e)},j.exec=j.toArray=function(t){var e;return this.criteria.all&&(e=this.records),this.criteria.where&&(e=d.call(this,this.criteria.where,e||this.records)),this.criteria.or&&(e=e.concat(d.call(this,this.criteria.or,this.records)),e=b.call(this,[this.jQ.id],e)),this.criteria.order&&(e=m.call(this,this.criteria.order,e||this.records)),this.criteria.near&&(e=k.call(this,this.criteria.near,e||this.records)),this.criteria.uniq&&(e=b.call(this,this.criteria.uniq,e||this.records)),this.criteria.select&&(e=_.call(this,this.criteria.select,e||this.records)),this.criteria.pluck&&(e=P.call(this,this.criteria.pluck,e||this.records)),this.criteria.limit&&(e=(e||this.records).slice(this.criteria.offset||0,(this.criteria.offset||0)+this.criteria.limit)),this.criteria.group_by&&(e=v.call(this,this.criteria.group_by,e||this.records)),e||(e=this.records),t&&r(e,t),this.jQ.onResult&&this.jQ.onResult(e,this.criteria),e};var C=function(t,e){var i;this.criteria[t]||(this.criteria[t]={});for(i in e)this.criteria[t][i]=e[i];return this};j.where=function(t){return C.call(this,"where",t)},j.or=function(t){return C.call(this,"or",t)},j.groupBy=function(t){return this.criteria.group_by=t,this},j.select=function(){return this.criteria.select=arguments,this},j.pluck=function(t){return this.criteria.pluck=t,this},j.limit=function(t){return this.criteria.limit=t,this},j.offset=function(t){return this.criteria.offset=t,this},j.order=function(t){var e;this.criteria.order=this.criteria.order||[];for(e in t)this.criteria.order.push({field:e,direction:t[e].toLowerCase()});return this},j.uniq=function(){return this.criteria.uniq=!(arguments.length>0)||arguments,this},Object.defineProperty(j,"count",{get:function(){this.criteria.count=!0;var t=this.exec();return"Array"==c(t)?this.exec().length:Object.keys(t).length}}),Object.defineProperty(j,"all",{get:function(){return this.criteria.all=!0,this.exec()}}),Object.defineProperty(j,"first",{get:function(){return this.criteria.first=!0,this.exec()[0]}}),Object.defineProperty(j,"last",{get:function(){this.criteria.last=!0;var t=this.exec();return t[t.length-1]}});
//Geocoding
...
//In IE 8 indexOf method not define.
    Array.prototype.indexOf||(Array.prototype.indexOf=function(t,e){for(var i=e||0,r=this.length;i<r;i++)if(this[i]===t)return i;return-1}),Object.defineProperty||(Object.defineProperty=function(t,e,i){t[e]=i.get})}(this),function(t,e,i){"use strict";function r(t,e){var i=a,r="var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('"+t.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(i.escape,function(t,e){return"',escapeStr("+e.replace(/\\'/g,"'")+"),'"}).replace(i.interpolate,function(t,e){return"',"+e.replace(/\\'/g,"'")+",'"}).replace(i.evaluate||null,function(t,e){return"');"+e.replace(/\\'/g,"'").replace(/[\r\n\t]/g," ")+";__p.push('"}).replace(/\r/g,"\\r").replace(/\n/g,"\\n").replace(/\t/g,"\\t")+"');}return __p.join('');",n=new Function("obj",r);return e?n(e):function(t){return n(t)}}function n(t,e){var i=t,r=[];for(i;i<=e;i++)r.push(i);return r}/*
   * Find html tag and parse options for filter
   */
    function s(e,i){var r="fjs-"+e,n=t("["+r+"]"),s=[];if(n.length)return t.each(n,function(){var e=t(this),i={ele:e},n=e.attr(r);return s.push(i),n?void t.each(n.split(","),function(t,e){var r=e.split("=");i[r[0]]=r[1]}):s}),i?s:s[0]}
//View Template
// Ref: Underscopre.js
//JavaScript micro-templating, similar to John Resig's implementation.
    var a={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g},h=function(e,i,r){var n=this;this.opts=r||{},this.callbacks=this.opts.callbacks||{},this.$container=t(i),this.view=this.opts.view||o,this.criterias=[],this._index=1,this.appendToContainer=this.opts.appendToContainer||l,this.has_pagination=!!this.opts.pagination,this.search_text="",this.anyFilterSelected=!1,this.setTemplate(this.opts.template),t.each(this.opts.criterias||[],function(){n.addCriteria(this)}),this.Model=JsonQuery(),this.Model.getterFns._fid=function(t){return t._fid},this.addRecords(e,this.opts.filter_on_init||!1),this.has_pagination&&this.initPagination()},c=h.prototype;Object.defineProperty(c,"records",{get:function(){return this.Model.records}}),Object.defineProperty(c,"recordsCount",{get:function(){return this.Model.records.length}}),c.templateBuilder=r,
//Callback
